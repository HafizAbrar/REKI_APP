...
class BusinessForgotPasswordScreen extends ConsumerStatefulWidget {
  const BusinessForgotPasswordScreen({super.key});

  @override
  ConsumerState<BusinessForgotPasswordScreen> createState() =>
      _BusinessForgotPasswordScreenState();
}

class _BusinessForgotPasswordScreenState
    extends ConsumerState<BusinessForgotPasswordScreen> {
  int _step = 1;
  ...
  Future<void> _requestReset() async {
    ...
    if (token != null && mounted) {
      ...
      // Token not in response — still advance, user checks email
      final hasError = ref.read(businessAuthProvider).hasError;
      if (!hasError) setState(() => _step = 2);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final isLoading = ref.watch(businessAuthProvider).isLoading;
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_step == 1) ...[
                    ...
                    const Text(
                      'Enter your business email and we\'ll send a reset code.',
