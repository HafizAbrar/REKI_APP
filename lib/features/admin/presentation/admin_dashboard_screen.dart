        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              title:
                  const Text('Venues', style: TextStyle(color: Colors.white)),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(
                    context,
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => const AdminRedemptionsScreen()));
              },
            ),
            ListTile(
          ...
          Row(children: [
            ...
            Expanded(
                child: _StatCard(
                    ...
                    label: 'Live Venues',
                    value: stats.liveVenuesNow.toString(),
          ...
          Row(children: [
            Expanded(
                child: _StatCard(
                    ...
                    value: stats.redemptionsToday.toString(),
          ...
          Row(children: [
            ...
            Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text(rt.fcmConfigured ? 'FCM Active' : 'FCM Inactive',
                    style: TextStyle(
                        color: rt.fcmConfigured
                            ? const Color(0xFF10B981)
                            : const Color(0xFFEF4444),
          ...
          Row(children: [
            Expanded(
                child: _StatCard(
                    ...
                    value: rt.activeWebSocketConnections.toString(),
                    color: const Color(0xFF3B82F6))),
            const SizedBox(width: 12),
            Expanded(
                child: _StatCard(
                    ...
                    value: rt.uniqueConnectedUsers.toString(),
                    color: const Color(0xFF8B5CF6))),
          ]),
          const SizedBox(height: 12),
          Container(
            ...
            child:
              ...
              Row(children: [
                Expanded(
                    child: _PushStat('Delivered', rt.pushDelivered,
                        const Color(0xFF10B981))),
                Container(width: 1, height: 50, color: const Color(0xFF334155)),
                Expanded(
                    child: _PushStat(
                        'Failed', rt.pushFailed, const Color(0xFFEF4444))),
                Container(width: 1, height: 50, color: const Color(0xFF334155)),
                Expanded(
                    child: _PushStat('Open Rate', null, const Color(0xFFF59E0B),
                        valueLabel: rt.pushOpenRate)),
              ]),
            ]),
          ),
        ],
          ...
          Row(children: [
            Expanded(
                child: _StatCard(
                    icon: Icons.sync,
                    label: 'Total Syncs',
                    value: off.totalSyncActions.toString(),
                    color: const Color(0xFF3B82F6))),
            const SizedBox(width: 12),
            Expanded(
                child: _StatCard(
                    ...
                    label: 'Successful',
                    value: off.successfulSyncs.toString(),
                    color: const Color(0xFF10B981))),
          ]),
        ],
      ),
          ...
          Row(children: [
            Expanded(
                child: _StatCard(
                    ...
                    value: loc.usersWithLocation.toString(),
                    color: const Color(0xFF3B82F6))),
            const SizedBox(width: 12),
            Expanded(
                child: _StatCard(
                    ...
                    value: loc.geofenceNotificationsSent.toString(),
                    color: const Color(0xFF8B5CF6))),
          ]),
        ],
      ),
