...
class _EditProfileScreenState extends ConsumerState<EditProfileScreen> {
  ...
  void _applyProfile(Map<String, dynamic> profile) {
    ...
    setState(() {
      ...
      _backgroundLocationEnabled =
          location['backgroundLocationEnabled'] == true;
      _existingAvatarUrl = profile['avatar']?.toString() ??
  ...
  Future<void> _save() async {
    ...
    if (success) {
      ...
      final error =
          ref.read(updateProfileProvider).error?.toString() ?? 'Update failed';
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(error),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed:
                    ref.watch(updateProfileProvider).isLoading ? null : _save,
